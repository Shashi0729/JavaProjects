...
<body>
	...
	<main class="container">
		<h2 class="text-center mb-4">Admin Update</h2>
				...
				<div style="width: 100%; max-width: 700px;">
					...
					<div class="row">
						...
						<input type="hidden" name="id" value="${dto.id}">
							...
							<label for="userName" class="form-label">Username</label> <input
								...
								name="userName" value="${dto.userName}" required>
						</div>
						<div class="col-md-4 mb-3">
							<label for="email" class="form-label">Email</label> <input
								type="email" class="form-control" id="email" name="email"
								onchange="checkEmail()" value="${dto.email}" required> <span id="response"></span>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4 mb-3">
							<label for="password" class="form-label">Password</label> <input
								...
								name="password" value="${dto.password}" required>
						</div>
						<div class="col-md-4 mb-3">
							<label for="contactNo" class="form-label">Contact Number</label>
							<input type="tel" class="form-control" id="contactNo"
								name="contactNo" onchange="checkContact()" value="${dto.contactNo}" required> <span
					...
					<div class="row">
						<div class="col-md-4 mb-3">
							...
							<input type="text" class="form-control" id="adharNumber"
								name="adharNumber" onchange="checkAdhar()" value="${dto.adharNumber}" required> <span
						...
						<div class="col-md-4 mb-3">
							<label for="alternativeContactNo" class="form-label">Alternative
								...
								id="alternativeContactNo" name="alternativeContactNo" value="${dto.alternativeContactNo}">
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4 mb-3">
							...
							value="${dto.state}"	required>
						</div>
						<div class="col-md-4 mb-3">
							<label for="city" class="form-label">City</label> <input
								type="text" class="form-control" id="city" name="city" value="${dto.city}" required>
						</div>
					</div>
