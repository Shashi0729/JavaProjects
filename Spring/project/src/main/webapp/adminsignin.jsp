...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container">
                ...
                <div class="ms-auto">
                    <a href="index.jsp" class="btn btn-custom-secondary">Home</a>
                </div>
            </div>
        </nav>
    </header>
    ...
    <main class="container my-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <form action="AdminSigninSubmit" method="post">
    ...
    //	function checkEmail() {
		...
		//	const req = new XMLHttpRequest;
			//req.open("GET", "http://localhost:8080/project/SignInGetAdminEmail?email="+ useremail);
			//req.send();
			//req.onload = function() {
