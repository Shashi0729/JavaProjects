...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container">
                ...
                <div>${email}</div>
                <a href="Activeusers" class="btn btn-custom-secondary">View Active Users</a>
                <a href="InActiveusers" class="btn btn-custom-secondary">View Inactive Users</a>
            </div>
        </nav>
    </header>
    ...
    <div class="container-fluid mt-4">
        <div class="table-responsive">
            <table class="table table-striped table-hover table-bordered text-center w-100">
                ...
                <tbody>
                    <c:forEach var="save" items="${viewActive}">
                        <tr>
                            ...
                            <td>${save.address}</td>
                            <td>
                                <a href="Adminupdate?email=${save.email}" class="btn btn-sm btn-primary">Update</a>
                                <a href="Admindelete?email=${save.email}" class="btn btn-sm btn-danger">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                    <c:forEach var="save" items="${viewInActive}">
                        <tr>
                            ...
                            <td>${save.address}</td>
                            <td>
                                <a href="Adminupdateinactive?email=${save.email}" class="btn btn-sm btn-warning">Update</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
